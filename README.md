...
<h3>Java Backend Developer passionate about building scalable and secure backend applications.</h3>
...
- ⚡ Implemented **Redis** for both performance (query caching in Trust Ledger) and security (Bucket4j-based rate limiting in Safe Share) across projects
